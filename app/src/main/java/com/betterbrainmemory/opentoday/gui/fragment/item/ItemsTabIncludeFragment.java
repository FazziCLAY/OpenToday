...
import com.betterbrainmemory.opentoday.databinding.FragmentItemsTabIncludeBinding;
import com.betterbrainmemory.opentoday.gui.GuiItemsHelper;
import com.betterbrainmemory.opentoday.gui.UI;
import com.betterbrainmemory.opentoday.gui.dialog.DialogSelectItemType;
...
import com.betterbrainmemory.opentoday.gui.interfaces.CurrentItemsTab;
import com.betterbrainmemory.opentoday.gui.interfaces.NavigationHost;
import com.betterbrainmemory.opentoday.gui.toolbar.AppToolbar;
import com.betterbrainmemory.opentoday.util.InlineUtil;
import com.betterbrainmemory.opentoday.util.Logger;
import com.betterbrainmemory.opentoday.util.QuickNote;
...
public class ItemsTabIncludeFragment extends Fragment implements CurrentItemsTab, NavigationHost {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        InlineUtil.viewClick(binding.addTabInlineButton, () -> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Logger.d(TAG, "onViewCreated", InlineUtil.nullStat(savedInstanceState));
    }
    ...
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        ...
        Logger.d(TAG, "onViewStateRestored", InlineUtil.nullStat(savedInstanceState), "todo: здесь что-то должно выполняться?");
        binding.viewPager.setAdapter(tabsViewPagerAdapter = new LocalViewPagerAdapter(this));
        updateViewPager(false);
    }
