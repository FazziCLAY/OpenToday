package com.betterbrainmemory.opentoday.gui.part
...
import com.betterbrainmemory.opentoday.app.items.item.filter.LogicContainerItemFilter.LogicMode
import com.betterbrainmemory.opentoday.databinding.PartLogicContainerItemFilterEditorBinding
import com.betterbrainmemory.opentoday.gui.EnumsRegistry
import com.betterbrainmemory.opentoday.gui.fragment.FilterGroupItemFilterEditorFragment
import com.betterbrainmemory.opentoday.gui.interfaces.Destroy
import java.util.GregorianCalendar

class LogicContainerItemFilterPartEditor(private val context: Context, layoutInflater: LayoutInflater, private val parentFilterGroup: com.betterbrainmemory.opentoday.app.items.item.FilterGroupItem, private val logicContainerItemFilter: com.betterbrainmemory.opentoday.app.items.item.filter.LogicContainerItemFilter, private val item: com.betterbrainmemory.opentoday.app.items.item.Item?, private val saveSignal: Runnable) : Destroy {
    companion object {
    ...
    private var colorInactive: Int = com.betterbrainmemory.opentoday.util.ResUtil.getAttrColor(context, R.attr.itemFilterState_false)
    private var colorActive: Int = com.betterbrainmemory.opentoday.util.ResUtil.getAttrColor(context, R.attr.itemFilterState_true)
    ...
    private var cached: HashMap<com.betterbrainmemory.opentoday.app.items.item.filter.ItemFilter, View> = HashMap()
    ...
    init {
        ...
        runnable = Runnable {
            ...
            cached.forEach { (t, u) ->
                val fitEquip =
                    com.betterbrainmemory.opentoday.app.items.item.filter.FitEquip(
                        GregorianCalendar()
                    );
        ...
        binding.description.addTextChangedListener(object : com.betterbrainmemory.opentoday.util.MinTextWatcher() {
        ...
        // LOGIC MODE
        val adapter: com.betterbrainmemory.opentoday.util.SimpleSpinnerAdapter<LogicMode> =
            com.betterbrainmemory.opentoday.util.SimpleSpinnerAdapter<LogicMode>(
                context
            );
        com.betterbrainmemory.opentoday.util.EnumUtil.addToSimpleSpinnerAdapter(context, adapter, LogicMode.values())
        ...
        binding.add.setOnClickListener {
            ...
            for (filterInfo in com.betterbrainmemory.opentoday.app.items.item.filter.FiltersRegistry.REGISTRY.allFilters) {
