...
import static com.betterbrainmemory.opentoday.util.InlineUtil.*;
...
import com.betterbrainmemory.opentoday.app.datafixer.DataFixer;
import com.betterbrainmemory.opentoday.app.datafixer.FixResult;
import com.betterbrainmemory.opentoday.app.items.ItemsRoot;
import com.betterbrainmemory.opentoday.app.items.QuickNoteReceiver;
...
import com.betterbrainmemory.opentoday.app.items.tick.TickThread;
import com.betterbrainmemory.opentoday.app.settings.SettingsManager;
import com.betterbrainmemory.opentoday.gui.activity.CrashReportActivity;
import com.betterbrainmemory.opentoday.plugins.PluginsRegistry;
import com.betterbrainmemory.opentoday.util.DebugUtil;
import com.betterbrainmemory.opentoday.util.InlineUtil;
import com.betterbrainmemory.opentoday.util.License;
...
import com.betterbrainmemory.opentoday.util.profiler.ProfilerImpl;
...
public class App extends Application {
    ...
    // DEBUG
    public static final boolean DEBUG = com.betterbrainmemory.opentoday.Build.isDebug();
    public static final boolean LOG = com.betterbrainmemory.opentoday.Build.isLogs();
    public static final boolean LOGS_SAVE = com.betterbrainmemory.opentoday.Build.isLogsSave();
    public static final boolean SECRET_SETTINGS_AVAILABLE = com.betterbrainmemory.opentoday.Build.isSecretSettingAvailable();
    ...
    private final List<FeatureFlag> featureFlags = new ArrayList<>(Arrays.asList(com.betterbrainmemory.opentoday.Build.INITIAL_FEATURE_FLAGS));
    ...
    public static Profiler createProfiler(@NotNull String name) {
        return com.betterbrainmemory.opentoday.Build.isProfilersEnabled() ? addProfiler(new ProfilerImpl(name)) : Profiler.EMPTY;
    }
