...
public class CrashReport {
    ...
    public String convertToText() {
        ...
        text = text.replace("%_BUILD_REPORT_%", getText(com.betterbrainmemory.opentoday.Build::getBuildDebugReport));
    ...
    private String generateRandomComment() {
        ...
        String[] comments = new String[] {
                ...
                // 2024.01.20
                "ownership: betterbrainmemory -> BetterBrainMemory",
                "Price? hehe",
                "New icon! (for humans)",
